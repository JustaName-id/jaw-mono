...
// Warning: (ae-forgotten-export) The symbol "StorePermissionApiResponse" needs to be exported by the entry point index.d.ts
//
// @public
...
// @public
export function handleGetCapabilitiesRequest(request: RequestArguments, apiKey: string, showTestnets?: boolean): Promise<Record<`0x${string}`, Record<string, unknown>>>;
...
// src/rpc/permissions.ts:94:5 - (ae-forgotten-export) The symbol "CallPermission" needs to be exported by the entry point index.d.ts
// src/rpc/permissions.ts:96:5 - (ae-forgotten-export) The symbol "SpendLimit" needs to be exported by the entry point index.d.ts
