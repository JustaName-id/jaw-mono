 ...
 * function only puts the approval last.
 */
export async function grantPermissions(
    ...
    prependCalls?: Array<{ to: Address; value?: bigint; data?: Hex }>
    ...
    const calls: Array<{ to: Address; value?: bigint; data?: Hex }> = [...(prependCalls ?? []), permissionCall];
