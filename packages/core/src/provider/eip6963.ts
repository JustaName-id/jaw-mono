import { announceProvider as mipdAnnounceProvider, type EIP1193Provider, type EIP6963ProviderInfo } from 'mipd';
 ...
 */
export function announceProvider(provider: ProviderInterface): AnnounceProviderCleanup | null {
