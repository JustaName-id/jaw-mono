  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 justify-between max-md:h-full h-full overflow-hidden">
        ...
        <div
          ref={scrollableRef}
          className="flex flex-col gap-3 flex-1 overflow-y-auto min-h-0 max-h-[60vh] max-md:pb-2"
        >
          ...
          {mode === 'revoke' && permissionId && (
            <div className="flex flex-col gap-2.5 p-3.5 border border-border rounded-[6px]">
              ...
              <p className="text-base font-normal leading-[150%] text-foreground break-all">{permissionId}</p>
            </div>
          )}
          ...
          <div className="flex flex-row justify-between items-center gap-2.5 p-3.5 border border-border rounded-[6px]">
            <div className="flex flex-col text-foreground gap-0.5 min-w-0 flex-1">
              ...
              <p className="text-base font-normal leading-[150%] truncate overflow-hidden">{origin}</p>
            </div>
          ...
          {totalSpends > 0 && (
            <div className="flex flex-col gap-2">
              <p className="text-sm font-bold text-foreground px-1">Spend Permissions ({totalSpends})</p>
              <div className="flex flex-col gap-2">
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      {isLoadingTokenInfo ? (
                        ...
                        <div className="flex items-center gap-2">
                          <p className="text-xl font-normal leading-[150%] text-foreground">{spend.amount}</p>
                          {spend.amountUsd && (
                    ...
                    <div className="flex flex-row justify-between items-center gap-2.5">
                      ...
                      <div className="flex flex-col gap-0.5 flex-1">
                        ...
                        <p className="text-base font-normal leading-[150%] text-foreground">
          ...
          {totalCalls > 0 && (
            <div className="flex flex-col gap-2">
              <p className="text-sm font-bold text-foreground px-1">Call Permissions ({totalCalls})</p>
              <div className="flex flex-col gap-2">
          ...
          {mode === 'grant' ? (
            <div className="flex items-start gap-2.5 p-3.5 border border-border rounded-[6px] bg-warning/10">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
              ...
              <div className="flex flex-col gap-1">
                <p className="text-xs font-bold leading-[133%] text-warning-foreground">Warning</p>
            ...
            <div className="flex items-start gap-2.5 p-3.5 border border-border rounded-[6px] bg-info/10">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="flex-shrink-0 mt-0.5 text-info"
              >
              ...
              <div className="flex flex-col gap-1">
                <p className="text-xs font-bold leading-[133%] text-info-foreground">Info</p>
                <p className="text-xs font-normal leading-[150%] text-info-foreground">
                  ...
                  <div className="flex flex-col gap-0.5 w-full">
                    <div className="flex items-center justify-between w-full">
                      <div className="flex flex-col">
                        <p className="text-sm text-destructive font-medium">Gas Estimation Failed</p>
                        <p className="text-xs text-destructive">{gasEstimationError}</p>
                      </div>
