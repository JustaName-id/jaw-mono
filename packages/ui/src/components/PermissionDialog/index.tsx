        ...
        >
              ...
              <div className="flex flex-row items-center justify-between">
                ...
                {isPermissionIdCopied ? (
                  ...
                  <CopyIcon
                    ...
                    height={16}
                    onClick={() =>
                      copyToClipboard(permissionId, setIsPermissionIdCopied)
                    }
          ...
          <div className="flex flex-row justify-between items-center gap-2.5 p-3.5 border border-border rounded-[6px]">
            ...
            <div className="flex flex-col text-foreground gap-0.5 min-w-0 flex-1">
              ...
              <div className="flex flex-row items-center gap-1">
                ...
                />
                <p className="text-base font-normal leading-[150%] truncate overflow-hidden">
                  {resolvedAddresses[spenderAddress] ||
                  ...
                  >
                    ...
                    <div className="flex flex-row justify-between items-center gap-2.5">
                      ...
                      <div className="flex flex-col gap-0.5 flex-1">
                        ...
                        <p className="text-base font-normal leading-[150%] text-foreground">
                          {isNativeToken(spend.tokenAddress)
                            ? `Native (${nativeSymbol})`
                            : spend.token}
                        </p>
                      </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <p className="text-sm font-mono leading-[150%] text-foreground break-all">
                        {getContractDisplayName(call.target) ||
                          resolvedAddresses[call.target] ||
                          call.target}
                      </p>
                    </div>
                  </div>
          ...
          {mode === "grant" ? (
            ...
            <div className="flex items-start gap-2.5 p-3.5 border border-border rounded-[6px] bg-info/10">
              <div className="flex-shrink-0 mt-0.5 text-info">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
              ...
              <div className="flex flex-col gap-1">
                <p className="text-xs font-bold leading-[133%] text-info-foreground">
                  Info
                </p>
                <p className="text-xs font-normal leading-[150%] text-info-foreground">
                  This will revoke all permissions and prevent the spender from
                  making any further transactions on your behalf.
                </p>
              </div>
            </div>
          )}
