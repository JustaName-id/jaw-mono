      ...
      >
        ...
        <div className="text-right shrink-0">
          {gasCost?.usd ? (
            ...
            <span className="text-[10px] text-destructive">{token.balance === 0n ? '0' : 'Insufficient'}</span>
          ) : null}
        </div>
      </button>
    );
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-64 p-0" align="end" sideOffset={4}>
        ...
        <div className="flex items-center justify-between px-3 py-2.5 border-b">
          ...
          <button onClick={() => setOpen(false)} className="rounded-full p-0.5 hover:bg-muted transition-colors">
            <X className="size-4" />
          </button>
        </div>
        ...
        <div className="p-1.5 max-h-64 overflow-y-auto">
          ...
          {nativeToken && (
            <div className="mb-1">
              <p className="text-[10px] font-medium text-muted-foreground px-2 py-1">Pay with {nativeToken.symbol}</p>
          ...
          {erc20Tokens.length > 0 && (
            <div>
              <p className="text-[10px] font-medium text-muted-foreground px-2 py-1">Pay with other tokens</p>
