        ...
        spends: [
          {
            ...
            allowance: parseEther('0.1').toString(), // 0.1 ETH
            unit: 'day',
          },
        ],
      },
...
| `address`      | `0x${string}` | No       | Account address to grant permissions on       |
...
| `allowance`  | `string`      | Yes      | Spending allowance in wei (decimal or hex string) |
        ...
        spends: [
          {
            ...
            allowance: parseUnits('1000', 6).toString(), // 1000 USDC per day
            unit: 'day',
          },
        ],
      },
