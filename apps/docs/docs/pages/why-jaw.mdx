...
- **Mobile teams** shipping native iOS and Android apps — the same passkey smart account runs in [React Native](/guides/react-native) with the platform's native passkey prompt
