...
4. Encrypt the key to `~/.jaw/keystore.json`
...
Encrypted session private key (AES-256-GCM, encrypted with your API key):
...
The keystore is useless without your API key. On-chain PermissionManager is the primary security boundary.
