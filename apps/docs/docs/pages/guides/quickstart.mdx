...
| **React Native** | Native iOS and Android apps built with Expo or React Native CLI, using the Core SDK's `Account` class with native passkeys. See the [React Native guide](/guides/react-native). |

:::info
This guide shows the Wagmi and Core SDK approaches. Choose the tabs that match your setup.
:::
